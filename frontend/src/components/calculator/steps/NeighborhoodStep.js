...
import { NeighborhoodIllustration } from './Illustrations';
...
export default function NeighborhoodStep({ value, onNext, onBack, loading }) {
  ...
  return (
    <StepWrapper
      illustration={<NeighborhoodIllustration />}
      title="Neighborhood & land"
      subtitle="Land cost varies more than anything else in a home budget — pick what fits best."
      onBack={onBack}
