...
export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '56px 20px 64px', color: 'var(--text-muted)', fontSize: 14.5, lineHeight: 1.8 }}>
      <Helmet><title>Privacy Policy | HomeCostCal</title></Helmet>
      ...
      <p style={{ marginBottom: 16 }}>
        HomeCostCal does not require an account or email address to use the calculator. The inputs you enter (state,
      ...
      <p style={{ marginBottom: 16 }}>
        ...
        nearby amenities. These are third-party public services with their own privacy practices.
      </p>
      <p>
        We may use privacy-respecting analytics to understand aggregate usage of the site. If you have questions about
        this policy, contact us at hello@homecostcal.com.
      </p>
    </div>
  );
}
