...
export default function Contact() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '56px 20px 64px', color: 'var(--text-muted)', fontSize: 15, lineHeight: 1.8 }}>
      <Helmet><title>Contact | HomeCostCal</title></Helmet>
      ...
      <a href="mailto:hello@homecostcal.com" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--primary)', color: 'white', padding: '12px 22px', borderRadius: 9, fontWeight: 700, fontSize: 14.5 }}>
        <Mail size={16} /> hello@homecostcal.com
      </a>
    </div>
  );
}
